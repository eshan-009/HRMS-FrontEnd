...
const Tooltip = () => {
  ...
  return (
    ...
    <div className={`w-7 h-7 mb-2 bg-slate-400 rotate-45 translate-y-6 z-20 `}></div>
    <div className=' bg-slate-400 p-5 w-full rounded-lg flex flex-col items-start justify-center'>

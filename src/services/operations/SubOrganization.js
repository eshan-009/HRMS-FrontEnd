...
const {
  ...
  ASSIGN_ORGANIZATION_TO_SUBORGANIZATION,
  REMOVE_ORGANIZATION_FROM_SUBORGANIZATION,
} = Sub_Organization_EndPoints;
...
export const assignOrganizationToSubOrganization = (
  branchId,
  organizationId
) => {
...
export const removeOrganizationFromSubOrganization = (
  branchId,
  organizationId
) => {
  return async (dispatch) => {
